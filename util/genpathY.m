function p = genpathY(d)
% genpathY Like built-in genpath, but omits directories whose name is
% 'Old',  'CVS', etc
...
for i=1:length(dirs)
    ...
    if    ~strcmp( dirname,'.')         && ...
            ...
            isempty(strfind(dirname, 'old'))
        p = [p genpathY(fullfile(d,dirname))]; % recursive calling of this function.
    end
end
